...
<body>
    ...
    <main class="container mt-5">
        ...
        <form action="PHP/edform.php" method="POST">
            ...
            <!-- Mengelompokkan form Materi 1 hingga 7 dalam satu baris -->
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
            ...
            <!-- Mengelompokkan form Materi 3 hingga 9 dalam satu baris -->
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
            ...
            <!-- Mengelompokkan form Materi 5 hingga 7 dalam satu baris -->
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
            ...
            <!-- Mengelompokkan form Materi 7 hingga 9 dalam satu baris -->
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
            ...
            <!-- Mengelompokkan form Materi 9 hingga 11 dalam satu baris -->
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
            ...
            <!-- Mengelompokkan form Materi 11 hingga 14 dalam satu baris -->
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
            ...
            <!-- Lanjutkan dengan form Materi 13 dan 14 di sini -->
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
